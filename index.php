...
<head>
    <title>CellPak Solutions</title>
    <meta name="description" content="CellPak Solutions">
...
<body id="page-top" class="index">
    ...
    <div id="owl-main-carousel" class="owl-carousel owl-theme"> 
        <div class="item">
            <img src="ui/images/banner-1.jpg" alt="The Last of us">
            <div class="carousel-caption">
                <h3>Delivering Intelligent Capability</h3>
